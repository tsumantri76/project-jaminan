        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Input Data Bank</li>
                </ol>
            </section>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="{{ url('admin/setting_bank/store') }}" method="POST">
                            {{ csrf_field() }}
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="rekening" id="rekening" value="{{ old('rekening') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="title">Proyek</label>
                                            <select name="id_proyek" id="id_proyek" class="form-control">
                                                @foreach ($proyeks as $row)
                                                    <option value="{{ $row->id }}">{{ $row->proyek }}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                    <div class="form-group">
