        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Input Data Agenda</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Input Data Agenda</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            ...
                            {{ csrf_field() }}
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="body" rows="10" placeholder="Enter ...">{{ old('body') }}</textarea>
                                    </div>
                                    <div class="form-group">
                                </div>
                                <!-- /.box-body -->
