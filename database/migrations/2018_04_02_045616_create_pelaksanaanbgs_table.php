...
class CreatePelaksanaanbgsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pelaksanaanbgs', function (Blueprint $table) {
            $table->increments('id');
            $table->string('no_surat_ket');
    ...
    {
        Schema::dropIfExists('pelaksanaanbgs');
    }
}
